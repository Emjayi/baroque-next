        ...
        return (
            ...
            >
                <motion.div
                    ...
                    animate={!isMobile ? (isOpen ? { opacity: [0, 0, 0, 0, 1, 1], y: [null, "20dvh", "20dvh"], x: [0, 0, 0, 100, 100] } : { opacity: [null, 0, 0, 0, 0, 0], y: null, x: [null, 60, 0, 0, 0, 0] }) : (isOpen ? { opacity: [0, 0, 0, 0, 1, 1], y: ["0dvh", "13dvh", "13dvh"], x: [0, 0, 0, 50, 50] } : { opacity: [null, 0, 0, 0, 0, 0], y: ["13dvh", "13dvh", "13dvh"], x: [null, 20, 0, 0, 0, 0] })}
                    exit={!isMobile ? (isOpen && { opacity: [1, 1, 1, 1, 0], y: "13dvh", x: [null, null, null, 60, 60], transition: { delay: 0 } }) : (isOpen && { opacity: [1, 1, 1, 1, 0], y: "13dvh", x: [null, null, null, 30, 30], transition: { delay: 0 } })}
