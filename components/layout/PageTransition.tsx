        ...
        <>
            ...
            <motion.div
                ...
                <motion.svg
                    ...
                    exit={!intro ? (open ? { scale: [null, null, null, null, null, 1], opacity: [null, 1, 1, 1, 1, 1], x: [null, null, 0, 0, 0, 0], y: [null, null, null, null, "0dvh", "0dvh"] } : { scale: [3, 1], opacity: [0, 0, 1], transition: { duration: .9, ease: "easeOut" } }) : { scale: 1, opacity: [.02, .02, .02, .02, .02, 1] }}
                    ...
                    <motion.g
                        initial={{ opacity: 1 }}
                        animate={!intro ? (open ? { opacity: 1 } : { opacity: 1 }) : ({ opacity: .6 })}
