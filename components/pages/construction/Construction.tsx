...
const Construction = ({ id, name, alt, url, blur, mainImage, status, gallery, type, year }: any) => {
    ...
    return (
        ...
        >
            ...
            {/* Desktop View */}
            <div className='hidden md:block md:w-[380px] h-[88vh]'>
                <motion.div
                    className='image-container hidden md:block w-[380px] h-[88vh]'
            ...
            <div className=''>
                ...
                <motion.div
                    ...
                    className='bg-black/50 absolute top-0 z-50 py-2  tracking-widest text-center md:w-[380px] w-[300px] font-bold text-white'>
