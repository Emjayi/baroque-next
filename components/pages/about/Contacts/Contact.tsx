    ...
    return (
        <Link
            ...
            <motion.div
                ...
                <div className={!isHover ? `h-8 w-8 flex justify-start items-center opacity-25 duration-500` : 'h-10 w-10 flex justify-center items-center opacity-75 duration-500'}>{icon}</div>
                <motion.div >
                    ...
                    <p className={isHover ? 'text-[18px] text-primary/90 duration-200 w-36' : 'text-[16px] text-zinc-300 duration-200 w-36'}>{desc}</p>
                </motion.div>
            </motion.div>
        </Link>
    )
