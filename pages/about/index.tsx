        ...
        <><div className='bg'></div><div className='flex h-[99vh] items-center'>
            <div className='flex h-[90vh] items-center gap-5 px-8 border-r-0 border-l-0 text-white text-6xl border-white border-2'>
                ...
                <HorizantalScroll>
                    ...
                    <div className=' flex items-center border-black border-4 rounded-md ' ref={container}>
                        <button className="button gradient-blue bg-blue-700" onClick={toggleTimeline}>button</button>
